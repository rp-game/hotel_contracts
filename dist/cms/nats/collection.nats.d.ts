...
export type DeleteCollectionResponse = NatsResponse<{
    success: boolean;
}>;
/**
...
export type AddMediaToCollectionResponse = NatsResponse<{
    success: boolean;
}>;
/**
...
export type RemoveMediaFromCollectionResponse = NatsResponse<{
    success: boolean;
}>;
/**
...
//# sourceMappingURL=collection.nats.d.ts.map