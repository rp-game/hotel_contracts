 ...
 * =============================================================================
 */
export type AdditionalServiceCategory = 'ROOM_SERVICE' | 'SPA_WELLNESS' | 'TRANSPORTATION' | 'FOOD_BEVERAGE' | 'LAUNDRY_CLEANING' | 'BUSINESS_SERVICES' | 'ENTERTAINMENT' | 'CONCIERGE' | 'PET_SERVICES' | 'OTHER';
