...
import { ChannelDistribution, UpsertChannelDistributionRequest, UpdateChannelDistributionRequest, ListChannelDistributionQuery, ChannelDistributionUpdatedEvent } from '../types/channel-distribution.types';
...
export type DeleteChannelDistributionNatsResponse = NatsResponse<{
    deleted: boolean;
}>;
export type ChannelDistributionUpdatedEventPayload = ChannelDistributionUpdatedEvent;
//# sourceMappingURL=channel-distribution.nats.d.ts.map