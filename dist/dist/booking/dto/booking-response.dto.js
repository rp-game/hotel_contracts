...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Per-room actual check-in timestamp (ISO)' }),
    __metadata("design:type", String)
], BookingRoomResponseDto.prototype, "actualCheckInTime", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Per-room actual check-out timestamp (ISO)' }),
    __metadata("design:type", String)
