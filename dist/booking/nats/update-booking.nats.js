...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Giờ check-in dự kiến/đã duyệt cho phòng này, bare "HH:mm" (KHÔNG phải ISO). Backend tự convert theo timezone khách sạn.', example: '15:00' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.Matches)(/^([0-1][0-9]|2[0-3]):[0-5][0-9]$/, { message: 'estimatedCheckInTime must be in HH:mm format' }),
    __metadata("design:type", String)
], UpdateBookingRoomDto.prototype, "estimatedCheckInTime", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Giờ check-out dự kiến/đã duyệt (late-checkout) cho phòng này, bare "HH:mm".', example: '15:00' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    ...
    __metadata("design:type", Number)
], UpdateBookingRoomDto.prototype, "earlyCheckInFee", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Phí check-out muộn (VND, gross) của riêng phòng này.', example: 200000 }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], UpdateBookingRoomDto.prototype, "lateCheckOutFee", void 0);
/**
