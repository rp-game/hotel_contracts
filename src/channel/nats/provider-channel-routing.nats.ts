...
import {
  ...
  UpsertProviderChannelRoutingRequest,
  ListProviderChannelRoutingQuery,
} from '../types/provider-channel-routing.types';
...
export type DeleteRoutingNatsResponse = NatsResponse<{ deleted: boolean }>;
