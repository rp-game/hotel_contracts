...
export type ListChannelOtaMappingsNatsResponse = { success: boolean; data: ChannelOtaMapping[] };
export type UpsertChannelOtaMappingNatsResponse = { success: boolean; data?: ChannelOtaMapping; message?: string };
export type DeleteChannelOtaMappingNatsResponse = { success: boolean; message?: string };
export type SyncOtaMappingsNatsResponse = { success: boolean; data?: SyncOtaMappingsResult; message?: string };
export type ListStaahOtaChannelsNatsResponse = { success: boolean; data: StaahOtaChannel[] };
