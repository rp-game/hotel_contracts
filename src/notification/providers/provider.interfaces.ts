...
export interface BaseProvider {
  ...
  validateConfig(config: ResolvedProviderConfig): { valid: boolean; errors?: string[] };
  healthCheck(config: ResolvedProviderConfig): Promise<{ healthy: boolean; message?: string }>;
}
