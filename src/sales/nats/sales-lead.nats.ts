...
export class SalesLeadResponse {
  ...
  @ApiPropertyOptional({ nullable: true }) estimatedRevenue: number | null;
  @ApiPropertyOptional({ nullable: true }) estimatedRoomNights: number | null;
  @ApiProperty() salesPersonId: string;
  @ApiProperty() salesPersonName: string;
  @ApiPropertyOptional({ nullable: true }) expectedCloseDate: string | null;
  @ApiPropertyOptional({ nullable: true }) lostReason: string | null;
  @ApiPropertyOptional({ nullable: true }) convertedAccountId: string | null;
