...
export class RatePlanPricingItem {
  ...
  @ApiPropertyOptional({ type: Number, nullable: true }) mondayPrice?: number | null;
  @ApiPropertyOptional({ type: Number, nullable: true }) tuesdayPrice?: number | null;
  @ApiPropertyOptional({ type: Number, nullable: true }) wednesdayPrice?: number | null;
  @ApiPropertyOptional({ type: Number, nullable: true }) thursdayPrice?: number | null;
  @ApiPropertyOptional({ type: Number, nullable: true }) fridayPrice?: number | null;
  @ApiPropertyOptional({ type: Number, nullable: true }) saturdayPrice?: number | null;
  @ApiPropertyOptional({ type: Number, nullable: true }) sundayPrice?: number | null;
